  ...
  return (
    <div className="flex w-full flex-col gap-6 lg:hidden">
      <div className="mx-auto mt-8 flex items-center px-2 lg:hidden">
        <Link href="/" className="flex items-center px-2 sm:px-0 ">
          <LogoSquare />
        </Link>
        <div className="ml-2 flex-none text-sm font-medium uppercase">{process.env.SITE_NAME}</div>
      </div>
      <div className="mx-auto w-full bg-white/80 dark:bg-transparent">
        <Disclosure>
          {({ open }) => (
            <>
              <Disclosure.Button className="flex w-full justify-between border-0 border-y-[1px] bg-gray-100 px-6 py-5 text-left text-sm font-medium text-purple-900 duration-500 hover:bg-gray-200 focus:outline-none focus-visible:ring focus-visible:ring-purple-500/75 dark:border-gray-700 dark:bg-neutral-800 dark:hover:bg-neutral-700 sm:px-3 md:px-2 lg:px-0">
