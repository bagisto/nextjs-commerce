...
export const SearchSkeleton = () => {
  return (
    <div className="max-w-[550px] relative w-full md:min-w-[386px] xl:min-w-[516px]">
      <input
        className="input w-full rounded-lg border border-neutral-200 bg-white py-2 pl-3 pr-10 text-sm text-black outline-none placeholder:text-selected-black dark:border-neutral-800 dark:bg-transparent dark:text-white dark:placeholder:text-neutral-400 md:pl-4"
