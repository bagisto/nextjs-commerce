  ...
  return (
    <div className="w-full max-w-full">
      ...
      <div className="flex items-center mt-5 lg:mt-6 mb-6 lg:mb-7_5 pb-2.5 lg:border-none lg:pb-0">
        <div className="h-8 lg:h-11 w-32 bg-neutral-200 dark:bg-neutral-800 rounded-lg animate-pulse" />
      </div>
      ...
      <div className="w-full xl:max-w-[1030px] bg-white dark:bg-neutral-900 lg:border lg:border-border-muted dark:lg:border-neutral-800 lg:rounded-md overflow-hidden shadow-sm">
              ...
              {[...Array(5)].map((_, idx) => (
                <tr key={idx} className="h-18">
                  ...
                  <td className="px-6 py-4 text-left">
                    <div className="h-6 w-24 bg-neutral-200 dark:bg-neutral-800 rounded-xl animate-pulse" />
                  </td>
                  <td className="px-6 py-4 text-left">
        ...
        <div className="px-8 py-6 flex-col sm:flex-row justify-between items-center gap-6 hidden lg:flex border-t border-neutral-100 dark:border-neutral-800">
          <div className="h-5 w-56 bg-neutral-200 dark:bg-neutral-800 rounded animate-pulse" />
