...
import { IMAGES, DOWNLOADABLE_STATUS_OPTIONS, PER_PAGE_LIMIT_OPTIONS } from "@/utils/constants";
import { DATE_QUICK_FILTERS, getQuickDateRange, getQuickDateLabel } from "@/utils/dateFilters";

export default function DownloadableProductFilters({
    initialLimit
}: {
    initialLimit: number;
}) {
    ...
    }, [filterOrderId, filterStatus, filterDateRange, searchParams]);

    const hasAnyFilter = useMemo(() => {
        return !!(filterOrderId || filterStatus || filterDateRange.start || filterDateRange.end);
    }, [filterOrderId, filterStatus, filterDateRange]);
        ...
        <div className="flex flex-col lg:flex-row justify-between items-center gap-4 mb-4 w-full xl:max-w-[1030px]">
            ...
            >
                <DrawerContent>
                    ...
                    <DrawerBody className="px-8 py-8 flex flex-col h-full scrollbar-hide overflow-y-auto font-outfit">
                        <div className="flex flex-col gap-8 pb-32">
                            ...
                            <div className="flex flex-col gap-3">
                                <div className="flex justify-between items-center">
                                    <span className="font-outfit text-sm font-medium text-black dark:text-white">Date</span>
                            ...
                            <div className="flex flex-col gap-3">
                                ...
                                >
                                    {DOWNLOADABLE_STATUS_OPTIONS.map((opt) => (
                            ...
                            <button
                                ...
                                className={clsx(
                                    ...
                                    isModified || hasAnyFilter
                                        ...
                                        : "bg-neutral-100 dark:bg-neutral-800 text-neutral-500 dark:text-neutral-300 cursor-not-allowed shadow-none"
                                )}
